...
contextBridge.exposeInMainWorld("electronAPI", {
  ...
  ethBalances: (chainId, rpcUrl, addresses) => ipcRenderer.invoke("eth-balances", { chainId, rpcUrl, addresses }),
  ...
  safeTxTypedData: (args) => ipcRenderer.invoke("safe-tx-typed-data", args),
